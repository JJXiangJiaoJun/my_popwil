...
e.g
    ...
    LinearKalmanEstimator<3>::TransitionMat F(LinearKalmanEstimator<3>::TransitionMat::Identity());
    LinearKalmanEstimator<3>::MeasureMat H(LinearKalmanEstimator<3>::MeasureMat::Identity());
    LinearKalmanEstimator<3> sinewaveEstimator(F1, 0.7, F, H, 0.1, 0.5);
